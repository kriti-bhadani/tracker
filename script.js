...
function createIssue(item) {
    ...
    issueItem.classList.add("mt-4", "p-4", "list-item-container", "bg-white" , "rounded")
    ...
    statusEle.classList.add("badge", "badge-pill", "px-4", "py-3");
    ...
    priorityText.classList.add("bg-secondary", "text-white", "badge", "px-4", "py-3")
